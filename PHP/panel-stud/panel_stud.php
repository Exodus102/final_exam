...
<body class="font-poppins">
    <div class="flex h-screen p-5">
        <div class=" sticky flex flex-col w-1/5 border-[3px] border-[#E9E3FF] rounded-xl shadow-xl
            pl-5 pr-5">
            ...
            <div class="flex flex-col text-[#424040]">
                ...
                <a href="panel_stud.php?page=assessment" class="flex items-center m-2 space-x-5 p-1 rounded-lg hover:bg-gray-100 focus:bg-[#E9E3FF]
                <?php echo (isset($_GET['page']) && $_GET['page'] === 'assessment') ? 'bg-[#E9E3FF]' : ''; ?>">
        ...
        <div class="w-full">
            <?php
            $page = isset($_GET['page']) ? $_GET['page'] : 'home_panel_stud'; // Provide a default page
            $allowedpages = [
                'home_panel_stud' => "../pages/home-stud/home_stud.php",
                'assessment' => "../pages/classes-stud/classesv2.php",
                'settings_stud' => "settings_stud.php",
                'classes_stud' => "../pages/classes-stud/classes_stud.php",
                'professor_details' => "../pages/classes-stud/professor-details.php", // Path to professor details
            ];
            
            if (array_key_exists($page, $allowedpages)) {
                include $allowedpages[$page];
            } else {
                echo "<h1 class='text-red-500 text-xl'>Page Not Found</h1>";
            }
