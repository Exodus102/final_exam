...
if ($stmt_user) {
    ...
    if ($result_user->num_rows > 0) {
        ...
        $profilePic = $user['profile_pic']; // Blob
    } else {
...
<div class="flex h-full">
    ...
    <div class="invisible lg:visible mt-5 w-full ml-5 sm:w-1/3 flex flex-col" id="profile-area">
        ...
        <div class="w-full h-1/2 bg-[#EFEFEF] flex flex-col items-center shadow-lg rounded-xl mb-3">
            ...
            <!-- Profile Picture -->
            <?php if ($profilePic): ?>
                <img src="../../PHP/pages/display_image.php?id=<?php echo $userId; ?>" alt="Profile Picture" class="rounded-full w-24 h-24 object-cover mb-3">
            <?php else: ?>
                <img src="/final_exam-main/assets/images/no-dp.jpg" alt="Default Profile Picture" class="rounded-full w-20 h-20 object-cover mb-3">
            <?php endif; ?>
