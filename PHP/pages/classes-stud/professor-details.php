...
$sql_contents = "
    SELECT cc.lesson, cc.contents, cc.files, cc.file_name, cc.file_type, cc.file_size, ic.course_name 
...
if ($stmt_contents) {
    ...
    while ($row = $result_contents->fetch_assoc()) {
        $contents[] = [
            ...
            'files' => htmlspecialchars($row['files']),
        ...
        <div class="space-y-6">
            <?php if (count($contents) > 0): ?>
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition duration-300">
                        ...
                        <?php if ($content['files']): ?>
                            <div class="flex items-center space-x-2">
                                <a href="<?php echo htmlspecialchars($content['files']); ?>"
                ...
                <div class="flex justify-between items-center mt-6">
                    <div>
                        <a href="assessment.php?prof_id=<?php echo $profId; ?>&course_name=<?php echo $courseName; ?>"
