    ...
    <div class="flex flex-col items-center mt-20">
        <div class="flex flex-col">
            ...
            <div class="flex justify-between mb-5">
                <span id="userType" class="text-2xl">Professors</span>
                    ...
                    <tbody id="tableBody">
                        ...
                        ?>
                            <tr class="hover:bg-gray-100">
                                ...
                                <td><?php echo substr($prof['password'], 0, 5) . str_repeat('*', 5); ?></td>
                                ...
                                <td>
                                    <button class="editBtn"
                                        ...
                                        data-email="<?php echo $prof['email']; ?>"
                                        data-fname="<?php echo $prof['fname']; ?>"
                                        data-lname="<?php echo $prof['lname']; ?>">
                                        Edit
                                    </button>
                                </td>
                                <td>
