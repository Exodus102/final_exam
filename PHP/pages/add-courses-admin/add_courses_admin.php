...
<div class="p-5 font-poppins flex flex-col justify-center h-full gap-5">
    <h1 class="text-5xl font-[500]">Add Courses</h1>
    <form action="" method="POST" class="w-full flex flex-col gap-3">
        ...
        <button type="submit" class="p-3 rounded-lg shadow-lg bg-violet-500 hover:bg-violet-600 w-full">Submit</button>
    </form>
